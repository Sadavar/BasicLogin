...
class Home extends Component {
  constructor(props) {
    ...
    this.onTextboxChangeSignUpField = this.onTextboxChangeSignUpField.bind(this);
    this.onTextboxChangeSignUpValue = this.onTextboxChangeSignUpValue.bind(this);
  ...
  componentDidMount() {
    const obj = getFromStorage('Mern-Project');
    if (obj && obj.token) {
      const { token } = obj;
      // Verify token
          ...
          <div>
            ...
            /><br />
             <input
              ...
              value={signUpField}
              onChange={this.onTextboxChangeSignUpField}
            /><br />
             <input
              type="optValue"
              placeholder="Optional Value"
              value={signUpValue}
              onChange={this.onTextboxChangeSignUpValue}
            /><br />
